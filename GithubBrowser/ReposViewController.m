...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    self.toolbarItems = [NSArray arrayWithObjects:homeButton, spacer, searchButton, nil];
...
- (void)reloadRepos
{    
    [detailViewController showLoadIndicator];
...
{   
    ...
    if ([repositories count] == 0 || self.currentPage > MAX_PAGES)
    {
        ...
        [detailViewController hideLoadIndicator];
    } 
    else
    {
        self.currentPage += 1;
